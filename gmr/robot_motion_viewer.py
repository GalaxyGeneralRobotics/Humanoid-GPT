...
from .params import ROBOT_XML_DICT, ROBOT_BASE_DICT, VIEWER_CAM_DISTANCE_DICT, ASSET_ROOT
...
class RobotMotionViewer:
    def __init__(self,
        ...
        # self.xml_path = ASSET_ROOT / "unitree_g1_ultraman" / "g1_mjx_dance_vis.xml"
    ...
    def step(self, 
        ...
        if self.camera_follow:
            ...
            self.viewer.cam.elevation = -10  # Front view, tilted slightly downward
            # self.viewer.cam.azimuth = 180    # Face toward the robot
    ...
    def close(self):
        ...
        self.viewer.close()
        time.sleep(0.5)
        # Explicitly release model and data resources
